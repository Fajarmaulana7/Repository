...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 03, 2024 at 09:59 AM
...
(4, 1, 100, '2024-03-02 13:05:11'),
(5, 2, 1, '2024-03-02 13:05:22'),
(6, 8, 8, '2024-03-02 13:05:35'),
(7, 2, 20, '2024-03-02 14:53:25'),
(8, 1, 1, '2024-03-03 07:59:38');
...
(1, 'zay', '083196963410', 'pamokolan'),
(2, 'yadi nazril', '083222222222', 'kp.bojong sari'),
(3, 'Dian candra', '083311111111', 'kp.bojong koneng');
...
(2023000010, '2024-03-02 13:29:28', 1);
...
(1, 'mainan mobil moster', 'per dus', 140000, 105),
(2, 'Rc pesawat jet Airfo', 'per dus', 200000, 30),
(3, 'mobil jif', 'per dus', 59500, 15),
(8, 'tamiya racing car', 'per dus', 14000, 10);
...
--
ALTER TABLE `pesanan`
  MODIFY `idorder` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2023000011;
